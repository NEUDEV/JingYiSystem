						...
						<form class="navbar-form navbar-left" role="search"
							...
							<tr>
								...
								<td style="padding-left:30;padding-top:10;color:black;">
									...
									模板下载：<br><br> <a  href="downestudents.action">
									<font color=orange>点这里下载模板</font>
									</a> <br/>
									<br />文件路径：<br> 
									<!-- <input
									style="color:black;background-color:#5DA1E3;" type="file"
									name="upstudents" size="60"> -->
									<br>

									<div class="uploader blue">
										<input class="filename" readonly="" type="text"> 
										<input name="file" class="button" value="选择文件" type="button">
